...
public class MainMenu extends State {
    ...
    public void init(GameContainer gc) throws SlickException {
        menuWallpaper = new Image("resources/levels/space-wallpaper-menu.jpg");
    ...
    public void render(GameContainer gc, Graphics g, GameModel gm) {
        ...
        g.drawImage(startButton.getButtonImage(), startButton.getX(),
                startButton.getY());
        g.drawImage(highScoreButton.getButtonImage(), highScoreButton.getX(),
                highScoreButton.getY());
        g.drawImage(creditsButton.getButtonImage(), creditsButton.getX(),
                creditsButton.getY());
